<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="wfrReportesCliente.aspx.cs" Inherits="NtLinkAdministracion.wfrReportesCliente" %>
...
<link href="Styles/StyleBoton.css" rel="stylesheet" type="text/css" />
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList runat="server" ID="ddlMes">
                    <asp:ListItem runat="server" Text="Todos" Value="0"></asp:ListItem>
    ...
    <table>
        <tr>
            <td>Cliente:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><asp:DropDownList runat="server" ID="ddlCliente" AppendDataBoundItems="True" Width="95%"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
    </table>
    <asp:GridView runat="server" ID="gvReporte" AutoGenerateColumns="False" 
