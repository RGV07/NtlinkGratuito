<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaFirmas.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFacturaFirmas"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label42" class="control-label" runat="server" Text="RFC"></asp:Label>
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
       ...
       <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label30" class="control-label" runat="server" Text=" Vo. Bo."></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label31" class="control-label" runat="server" Text="Nombre"></asp:Label>
               <asp:TextBox runat="server" ID="txtVoBoNombre" CssClass="form-control"></asp:TextBox>
                        
            </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label32" class="control-label" runat="server" Text="Puesto"></asp:Label>
              <asp:TextBox runat="server" ID="txtVoBoPuesto" CssClass="form-control"></asp:TextBox>
                                     
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label33" class="control-label" runat="server" Text="Area"></asp:Label>
            <asp:TextBox runat="server" ID="txtVoBoArea" CssClass="form-control"></asp:TextBox>
                                                  
            </div>
       </div>
          <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label34" class="control-label" runat="server" Text=" Recibí"></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label35" class="control-label" runat="server" Text="Nombre"></asp:Label>
                <asp:TextBox runat="server" ID="txtRecibiNombre" CssClass="form-control"></asp:TextBox>         
            </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label36" class="control-label" runat="server" Text="Puesto"></asp:Label>
                <asp:TextBox runat="server" ID="txtRecibiPuesto" CssClass="form-control"></asp:TextBox>
                                                 
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label37" class="control-label" runat="server" Text="Area"></asp:Label>
               <asp:TextBox runat="server" ID="txtRecibiArea" CssClass="form-control"></asp:TextBox>
                                                               
            </div>
       </div>
                <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label38" class="control-label" runat="server" Text=" Autorizó"></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label39" class="control-label" runat="server" Text="Nombre"></asp:Label>
             <asp:TextBox runat="server" ID="txtAutorizoNombre" CssClass="form-control"></asp:TextBox>
                </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label40" class="control-label" runat="server" Text="Puesto"></asp:Label>
                 <asp:TextBox runat="server" ID="txtAutorizoPuesto" CssClass="form-control"></asp:TextBox>
                                                            
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label41" class="control-label" runat="server" Text="Area"></asp:Label>
            <asp:TextBox runat="server" ID="txtAutorizoArea" CssClass="form-control"></asp:TextBox>
              ...
              <div class = "row"> 
                  ...
                  <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label49" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
