<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrComplementoServicioParcialConstruccion.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrComplementoServicioParcialConstruccion"  EnableEventValidation="false" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
  ...
  <%@ Register Src="~/controles/ServicioParcialConstrucciones.ascx" TagPrefix="uc" TagName="UCImpuestosLocales" %>
    ...
    <section class="services">
     ...
     <div  class = "card mt-2">   
            <div class="card-header">
               <h3> Generar Servicio Parcial Contruccion</h3>
            </div>
            <div class ="card-body" >
              ...
              <div class = "row"> 
                  ...
                  <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label36" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
      ...
      <asp:Panel runat="server" CssClass="table-responsive">
        ...
        <div class = "card mt-2">   
            <div class = "card-header">
                ...
                Text="Servicio Parcial Construccion" OnCheckedChanged="cbCfdiConstruccion_CheckedChanged" />
            </div>
              <div class = "card-body" id="DivConstruccion" runat="server" >
             
                <div id="Complementos" style="width:100%;   text-align: left;" runat="server" >
       
                   <uc:UCImpuestosLocales id="servicioConstruccion"  runat="server"></uc:UCImpuestosLocales>
            </div>
                            </div>  <%--Termina panel-body--%>
