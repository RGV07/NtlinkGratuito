<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrCartaPorte.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrCartaPorte"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label3" class="control-label" runat="server" Text="RFC"></asp:Label>
                ...
                <div class = "row form-group " > 
                    ...
                    <asp:TextBox runat="server" ID="txtFechaPago" CssClass="form-control"  Visible="False" />
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="alert-error"
                         ID="RequiredFieldValidator1" ControlToValidate="txtFechaPago"
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
         ...
         <ContentTemplate>
               ...
               <ContentTemplate>
                <div class = "row form-group " > 
                   ...
                   <div class = "col-lg-12">
                      <h4> <asp:Label ID="Label31" runat="server" Text="Datos Carta Porte"></asp:Label> </h4>
                   </div>
                ...
                <div class = "row form-group " > 
                 <div class = "col-lg-3"></div>
               	...
               	<asp:TextBox runat="server" ID="txtAddendaDescripcion" Width="56%" CssClass="form-contro"/>
			<asp:RequiredFieldValidator runat="server" ID="rfvDescripcionAduana" ForeColor="Red"
                ErrorMessage="* Requerido" Display="Dynamic"
				 ControlToValidate="txtAddendaDescripcion" ValidationGroup="AgregarConceptoAduana" />
			                              </div>
                    <div class = "col-lg-3">
                   <asp:Label ID="Label32" runat="server" Text="Valor"></asp:Label> 
              <asp:TextBox runat="server" ID="txtAddendaValor" Width="56%" CssClass="form-contro"/>
				<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red"
                    Display="Dynamic"  ControlToValidate="txtAddendaValor" ErrorMessage="* Requerido"
                    ValidationGroup="AgregarConceptoAduana"></asp:RequiredFieldValidator>
				                         </div>
    ...
    Cssclass="btn btn-outline-success" OnClick="btnAgregarConceptoAduana_Click"></asp:Button>
              </div>
                 <div class = "col-lg-3">
                         <asp:Button ID="btnBorrarConceptosAddenda0" runat="server" 
                   Cssclass="btn btn-outline-success" OnClick="btnBorrarConceptosAddenda0_Click" 
                    Text="Borrar Lista" />
                     </div>
                 </div>
             <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                        <asp:GridView ID="gvDescripcionAddenda" runat="server" AutoGenerateColumns="False" GridLines="None" 
