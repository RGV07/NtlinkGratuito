<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaComplementos.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFacturaComplementos"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label30" class="control-label" runat="server" Text="RFC"></asp:Label>
    ...
    <section class="services">
     ...
     <div  class = "card mt-2">   
            <div class="card-header">
               <h3> Generar CFDI con Impuestos Locales</h3>
            </div>
            <div class ="card-body" >
              ...
              <div class = "row"> 
                  ...
                  <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label37" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
...
<br />                
    ...
    <asp:Button runat="server" ID="btnSelloDummy" Style="display: none;" />
      ...
      <asp:Panel runat="server" CssClass="table-responsive">
        ...
        <div class = "card mt-2">   
            <div class = "card-header">
                <asp:CheckBox ID="cbCfdiConstruccion" runat="server" AutoPostBack="true"
                Text="Impuestos Locales" OnCheckedChanged="cbCfdiConstruccion_CheckedChanged" />
            </div>
              <div class = "card-body" id="DivConstruccion" runat="server" >
           ...
           <uc:UCImpuestosLocales id="ImpuestosLocales"  runat="server"></uc:UCImpuestosLocales>
              ...
              <Triggers>
                   <asp:AsyncPostBackTrigger ControlID="cbCfdiConstruccion" EventName="CheckedChanged" /> 
        ...
        <div class = "card mt-2">
            ...
            <div class = "card-body">
             ...
             <div class = "row">
                  ...
                  <div class = "row">
                           <div  class="col-md-7 col-sm-0"></div>
                           <div class = "col-md-2 col-sm-6  text-right" style="padding:0"><b>Retenciónes Locales</b>:</div>
                           <div class = "d-inline-flex-reverse col-md-2 col-sm-6 text-right" style="padding:0">
                           <asp:Label ID="lblRetencionLocal" runat="server" /></div>
                           <div  class="col-md-1 col-sm-0"></div>
                           </div>
             <div class = "row">
                           <div  class="col-md-7 col-sm-0"></div>
                           <div class = "col-md-2 col-sm-6  text-right" style="padding:0"><b>Traslado Locales</b>:</div>
                           <div class = "d-inline-flex-reverse col-md-2 col-sm-6 text-right" style="padding:0">
                           <asp:Label ID="lblTrasladoLocal" runat="server" /></div>
                           <div  class="col-md-1 col-sm-0"></div>
                           </div>
