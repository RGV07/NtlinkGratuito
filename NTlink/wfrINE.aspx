<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrINE.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrINE"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label34" class="control-label" runat="server" Text="RFC"></asp:Label>
         ...
         <ContentTemplate>
           ...
           <asp:UpdatePanel ID="UpdatePanel8" runat="server"  UpdateMode="Conditional"  >
               <ContentTemplate>
                ...
                <div class = "row form-group " > 
                   <div class = "col-lg-12">
                      <h4>  <asp:Label ID="Label31" runat="server" Text="INE"></asp:Label></h4>
                   </div>
                </div>
                 <div class = "row form-group " > 
                      <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label33" runat="server" Text="Tipo de proceso"></asp:Label>
                    <asp:DropDownList ID="ddlTipoProc" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoProc_SelectedIndexChanged" CssClass="form-control">
                 ...
                 <div class = "col-lg-3" id="tr1" visible="false" runat="server">
                        <asp:Label ID="Label36" runat="server" Text="Tipo Comite"></asp:Label>
                        <asp:DropDownList ID="ddlTipoComite" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoComite_SelectedIndexChanged" CssClass="form-control">
                                                <asp:ListItem Value="0" Text="--Seleccione--" Selected="True" />
                    ...
                    <div class = "col-lg-3" id="tr2" visible="false" runat="server" >
                        <asp:Label ID="Label39" runat="server" Text="Ambito"></asp:Label>
                      <asp:DropDownList ID="ddlAmbito" runat="server" AutoPostBack="True"
                          OnSelectedIndexChanged="ddlAmbito_SelectedIndexChanged" CssClass="form-control">
                                                <asp:ListItem Value="0" Text="--Seleccione--" Selected="True" />
                  ...
                  <div class = "col-lg-3"></div>
                    <div class = "col-lg-3" runat="server" id="tdtxtcontabilidad" visible="false">
                        <asp:Label  runat="server" id="tdlblcontabilidad" visible="false" Text="IdContabilidad"></asp:Label>
                      <asp:TextBox ID="txtIdContabilidad" runat="server" MaxLength="6" CssClass="form-control"></asp:TextBox>
                  </div> 
                      
                       <div class = "col-lg-3" id="tdddlentidad" visible="false" runat="server">
                        <asp:Label id="tdlblentidad" visible="false"  runat="server" Text="ClaveEntidad"></asp:Label>
             ...
             <div runat="server" id="tblentidad" visible="false" >
            <div class = "row form-group "> 
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-4">
                  ...
                  <div class = "col-lg-3">
                          <asp:Button runat="server" ID="btnAgregarEntidad" Text="Agregar Entidad"
                                    ValidationGroup="AgregarEntidad" Cssclass="btn btn-outline-success" OnClick="btnAgregarEntidad_Click"/>
             ...
             <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                        <asp:GridView ID="gvEntidad" runat="server" AutoGenerateColumns="False" GridLines="None" 
                          ShowHeaderWhenEmpty="True" Width="100%"  AlternatingRowStyle-HorizontalAlign="Center"
                           ...
                           OnRowCommand="gvEntidad_RowCommand" >
                            <rowstyle Height="6px" /><alternatingrowstyle  Height="6px"/>
                            <Columns>
                  ...
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label30" runat="server" Text="IDEntidad"></asp:Label>
                               <asp:DropDownList ID="ddlIDContabilidad" runat="server" AutoPostBack="True" 
                                CssClass="form-control"
                                   onselectedindexchanged="ddlIDContabilidad_SelectedIndexChanged">
                                                </asp:DropDownList>
                 </div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label32" runat="server" Text="IdContabilidadEntidad"></asp:Label>
                              <asp:TextBox ID="txtIDContabilidadEntidad" runat="server" MaxLength="6" 
                                                        CssClass="form-control" ontextchanged="txtIDContabilidadEntidad_TextChanged"></asp:TextBox>
            ...
            FilterType="Numbers" TargetControlID="txtIDContabilidadEntidad"           Enabled="True" />
                  ...
                  <div class = "col-lg-3">
                         <asp:Button runat="server" ID="btnAgregarIDContabilidadEntidad" Text="Agregar IDContabilidadEntidad"
                                     Cssclass="btn btn-outline-success" OnClick="btnAgregarIDContabilidadEntidad_Click"/>   
                </div>
                 ...
                 <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                        <asp:GridView ID="dvIdContabilidad" runat="server" AutoGenerateColumns="False" GridLines="None" 
                          ShowHeaderWhenEmpty="True" Width="100%"  AlternatingRowStyle-HorizontalAlign="Center"
                            CssClass="table table-hover table-striped grdViewTable" 
                           OnRowCommand="dvIdContabilidad_RowCommand" >
                            <rowstyle Height="6px" /><alternatingrowstyle  Height="6px"/>
                            <Columns>
                                        <asp:BoundField HeaderText="ID" DataField="ID" ItemStyle-HorizontalAlign="Center" />
                     ...
                     <Triggers>
                           <asp:AsyncPostBackTrigger ControlID="ddlTipoProc" EventName="SelectedIndexChanged" /> 
                           <asp:AsyncPostBackTrigger ControlID="ddlTipoComite" EventName="SelectedIndexChanged" /> 
                           <asp:AsyncPostBackTrigger ControlID="ddlAmbito" EventName="SelectedIndexChanged" /> 
                           <asp:AsyncPostBackTrigger ControlID="ddlClaveEntidad" EventName="SelectedIndexChanged" /> 
              ...
              <div class = "row"> 
                ...
                <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label43" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
