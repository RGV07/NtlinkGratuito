<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrMabe.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrMabe"  EnableEventValidation="false" %>
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
              ...
              <asp:UpdatePanel ID="UpdatePanel8" runat="server"  UpdateMode="Conditional"  >
               <ContentTemplate>
                ...
                <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label31" runat="server" Text="Moneda tipoMoneda"></asp:Label>
                         <asp:TextBox runat="server" ID="txtMonedatipoMoneda" CssClass="form-control" />

                   </div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label33" runat="server" Text="No. interior"></asp:Label>
               		       <asp:TextBox runat="server" ID="txtnoInterior" CssClass="form-control"/>
			     </div>
                             <div class = "col-lg-3"></div>
                    </div>
             <div class="row form-group ">
                 <div class="col-lg-3"></div>
                 <div class="col-lg-3">
                     <asp:Label ID="Label34" runat="server" Text="Provedor codigo"></asp:Label>
                 	<asp:TextBox runat="server" ID="txtProvedorcodigo" CssClass="form-control" />
				
                 </div>
                 <div class="col-lg-3">
                     <asp:Label ID="Label35" runat="server" Text="FechaFinal"></asp:Label>
                  <asp:TextBox runat="server" ID="txtFechaFinal" CssClass="form-control"/>
					<asp:CalendarExtender runat="server" ID="CalendarExtender1" Format="dd/MM/yyyy"
						PopupButtonID="txtFechaFinal" TargetControlID="txtFechaFinal" 
						Enabled="True" />
					<asp:CompareValidator runat="server" ID="CompareValidator5" ForeColor="Red" ErrorMessage="* Fecha Invalida" Display="Dynamic"
					ControlToValidate="txtFechaFinal" Operator="DataTypeCheck" Type="Date" ValidationGroup="CrearFactura" />
			 </div>
                 <div class="col-lg-3"></div>
              ...
              <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label36" runat="server" Text="Entrega Codigo Postal"></asp:Label>
                     		<asp:TextBox runat="server" ID="txtEntregaCodigoPostal" CssClass="form-control"/>
			       </div>
                        <div class = "col-lg-3">
                        <asp:Label ID="Label37" runat="server" Text="Planta de Entrega"></asp:Label>
                    		<asp:TextBox runat="server" ID="txtPlantaEntrega" CssClass="form-control" />
			       <div class = "col-lg-3"></div>
               </div>
                  </div>
                   <div class = "row form-group "> 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label38" runat="server" Text="noExterior"></asp:Label>
                       	<asp:TextBox runat="server" ID="txtnoExterior" CssClass="form-control" />
				
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label39" runat="server" Text="Calle"></asp:Label>
 ...
 <div class = "row form-group" > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label40" runat="server" Text="FechaInicial" ></asp:Label>
            ...
            <asp:CalendarExtender runat="server" ID="ceVencimiento" Format="dd/MM/yyyy"
						PopupButtonID="txtFechaInicial" TargetControlID="txtFechaInicial" 
						Enabled="True" />
                        <asp:CompareValidator runat="server" ID="cvVencimiento" 
                          ErrorMessage="* Fecha Invalida" Display="Dynamic"  ForeColor="Red"
					     ControlToValidate="txtFechaInicial" Operator="DataTypeCheck" 
 ...
 <div class = "row form-group " > 
     ...
     <div class = "row form-group " > 
             ...
             <asp:TextBox runat="server" ID="txtDescrpcionAdenda"  CssClass="form-control"/>
 ...
 <div class = "row form-group"> 
				...
				<asp:RequiredFieldValidator runat="server" ID="rfvTotalFactura"
				 ...
				 Text="Agregar" onclick="btnAgregarConceptoAduana_Click" class="btn btn-outline-success"/>
                         </div>
               </div>
        ...
        <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                          ...
                          ShowHeaderWhenEmpty="True" DataKeyNames="Partida" Width="100%"
                             onrowcommand="gvConceptosAduana_RowCommand"
