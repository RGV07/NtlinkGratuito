<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrLiverpool.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrLiverpool"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label36" class="control-label" runat="server" Text="RFC"></asp:Label>
                ...
                <div class = "row form-group " > 
                    ...
                    <asp:TextBox runat="server" ID="txtFechaPago" CssClass="form-control"  Visible="False" />
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="alert-error"
                         ID="RequiredFieldValidator11" ControlToValidate="txtFechaPago"
	    ...
	    <asp:TabPanel  runat="server"  ID="datosAddenda" HeaderText="Addenda">
         ...
         <ContentTemplate>
                ...
                <div class = "row form-group " > 
                    <div class = "col-lg-1"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label31" runat="server" Text="Reference Identification"></asp:Label>
                        <asp:TextBox ID="OrderIdentification_ReferenceIdentification" runat="server" CssClass="form-control"></asp:TextBox>
                                    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*Campo Requerido"
                    ...
                    <div class = "col-lg-3">
                        <asp:Label ID="Label30" runat="server" Text="Delivery Note"></asp:Label>
                     <asp:TextBox ID="txtDeliveryNote" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Campo Requerido"
                                        ControlToValidate="txtDeliveryNote" Display="Dynamic"
                                        ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                    </div>             
             <div class = "col-lg-3">
                        <asp:Label ID="Label32" runat="server" Text="Buyer GLN"></asp:Label>
                              <asp:TextBox ID="BuyerSeller_GlnBuyer" runat="server" 
                                  MaxLength="13" CssClass="form-control" ></asp:TextBox>
                 ...
                 <div class = "row form-group " > 
                      <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                     <asp:Label ID="Label33" runat="server" Text="Person or Department Name"></asp:Label>
                       <asp:TextBox ID="txtpersonOrDepartmentName" runat="server" CssClass="form-control"></asp:TextBox>
                   </div>
              <div class = "col-lg-3">
                        <asp:Label ID="Label34" runat="server" Text="Seller GLN"></asp:Label>
                   <asp:TextBox ID="txtSellerGln" runat="server" MaxLength="13" CssClass="form-control"></asp:TextBox>
                              
           
             </div>
                        <div class = "col-lg-3">
                        <asp:Label ID="Label35" runat="server" Text=" Alternate Party Identification"></asp:Label>
                        <asp:TextBox ID="txtalternatePartyIdentification" runat="server"  CssClass="form-control"></asp:TextBox>
