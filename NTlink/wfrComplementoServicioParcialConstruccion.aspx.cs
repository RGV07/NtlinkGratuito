...
{
    public partial class wfrComplementoServicioParcialConstruccion : Page
    {
        ...
        //        ddlClaveUnidadE.Style.Remove("width");
                ...
                try
                {
                    ...
                    DivConstruccion.Attributes.Add("style", "display:none;");
        ...
        private void ClearAll()
        {
            ...
            cbCfdiConstruccion.Checked = false;
        ...
        protected void cbCfdiConstruccion_CheckedChanged(object sender, EventArgs e)
        {
            if (cbCfdiConstruccion.Checked == true)
            {
                DivConstruccion.Attributes.Add("style", "display:block;");
            }
            else
            {
                DivConstruccion.Attributes.Add("style", "display:none;");
    ...
    protected void bntEliminarImpuesto_Click(object sender, EventArgs e)
        ...
        private facturas GetFactura(string iniciales, List<facturasdetalle> detalles)
        {
            ...
            //-------------------------------------------------------------------------------
            ServicioParcialConstruccion ser = new ServicioParcialConstruccion();

            ser.Calle = convertirTexto("txtCalle", servicioConstruccion);
            ser.CodigoPostal = convertirTexto("txtCodigoPostal", servicioConstruccion);
            ser.Colonia = convertirTexto("txtColonia", servicioConstruccion);
            ser.Estado = convertirDrop("ddlEstado", servicioConstruccion);
            ser.Localidad = convertirTexto("txtLocalidad", servicioConstruccion);
            ser.Municipio = convertirTexto("txtMunicipio", servicioConstruccion);
            ser.NoExterior = convertirTexto("txtNoExterior", servicioConstruccion);
            ser.NoInterior = convertirTexto("txtNoInterior", servicioConstruccion);
            ser.NumPerLicoAut = convertirTexto("txtNumPerLicoAut", servicioConstruccion);
            ser.Referencia = convertirTexto("txtReferencia", servicioConstruccion);

            fact.parcialesconstruccion = ser;
            //---------------------------------------------------------------------------------------
