<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaVehiculoUsado.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFacturaVehiculoUsado"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label43" class="control-label" runat="server" Text="RFC"></asp:Label>
    ...
    <section class="services">
     ...
     <div  class = "card mt-2">   
            <div class="card-header">
               <h3> Generar CFDI VEhiculo Usado</h3>
            </div>
            <div class ="card-body" >
                ...
                <div class = "row form-group " > 
                    ...
                    <asp:TextBox runat="server" ID="txtFechaPago" CssClass="form-control"  Visible="False" />
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="alert-error"
                         ID="RequiredFieldValidator18" ControlToValidate="txtFechaPago"
      ...
      <asp:Panel runat="server" CssClass="table-responsive">
	    ...
	    <asp:TabPanel  runat="server"  ID="datosAddenda" HeaderText="Addenda">
         ...
         <ContentTemplate>
                ...
                <div class = "row form-group " > 
                    <div class = "col-lg-1"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label31" runat="server" Text="MontoAdquisicion"></asp:Label>
                          <asp:TextBox runat="server" ID="txtmontoAdquisicion" CssClass="form-control"></asp:TextBox>
      
                       <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" 
            FilterType="Custom, Numbers" TargetControlID="txtmontoAdquisicion" ValidChars="."  Enabled="True" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
            ControlToValidate="txtmontoAdquisicion" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red"
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red"
            ...
            ValidationGroup="AgregarAduanaVU" />                      
                    ...
                    <div class = "col-lg-3">
                        <asp:Label ID="Label30" runat="server" Text="MontoEnajenacion"></asp:Label>
                    <asp:TextBox ID="txtMontoEnajenacion" runat="server" CssClass="form-control"></asp:TextBox>
                        
                   <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" 
            FilterType="Custom, Numbers" TargetControlID="txtMontoEnajenacion" ValidChars="."  Enabled="True" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
            ControlToValidate="txtMontoEnajenacion" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
            ControlToValidate="txtMontoEnajenacion" Display="Dynamic" ErrorMessage="Dato invalido" ForeColor="Red"
            ValidationExpression="\d+\.?\d?\d?\d?\d?\d?\d?"   ValidationGroup="AgregarAduanaVU" />
                     
                    </div>             
             <div class = "col-lg-3">
                        <asp:Label ID="Label32" runat="server" Text="ClaveVehicular"></asp:Label>
                        <asp:TextBox ID="txtClaveVehicular" runat="server" CssClass="form-control" 
                            MaxLength="7"></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
            ControlToValidate="txtClaveVehicular" Display="Dynamic" ErrorMessage="Requerido"  ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
                 ...
                 <div class = "row form-group " > 
                      <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label33" runat="server" Text="Marca"></asp:Label>
                    <asp:TextBox runat="server" ID="txtMarca" MaxLength="50" 
                    CssClass="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
            ControlToValidate="txtMarca" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
               </div>
              <div class = "col-lg-3">
                        <asp:Label ID="Label34" runat="server" Text="Tipo"></asp:Label>
                    <asp:TextBox runat="server" ID="txtTipo" MaxLength="50" 
                    CssClass="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
            ControlToValidate="txtTipo" Display="Dynamic" ErrorMessage="Requerido"  ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
           
             </div>
                        <div class = "col-lg-3">
                        <asp:Label ID="Label35" runat="server" Text="Modelo"></asp:Label>
                <asp:TextBox runat="server" ID="txtModelo" MaxLength="4" 
                    CssClass="form-control"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
            ControlToValidate="txtModelo" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
            ...
            FilterType="Numbers" TargetControlID="txtModelo" 
                  ...
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label36" runat="server" Text="NumeroMotor"></asp:Label>
                           <asp:TextBox ID="txtNumeroMotor" runat="server" CssClass="form-control" MaxLength="17"></asp:TextBox>
                </div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label37" runat="server" Text="NumeroSerie"></asp:Label>
                             <td><asp:TextBox ID="txtNumeroSerie" runat="server" CssClass="form-control" 
                MaxLength="17"></asp:TextBox>
                 </div> 
                  <div class = "col-lg-3">
                        <asp:Label ID="Label38" runat="server" Text="NIV"></asp:Label>
                      <asp:TextBox ID="txtNIV" runat="server" CssClass="form-control" 
                MaxLength="17"></asp:TextBox>
                </div>
                  </div>
                  <div class = "row form-group " > 
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label39" runat="server" Text="Valor"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
            ControlToValidate="txtValor" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
            ControlToValidate="txtValor" Display="Dynamic" ErrorMessage="Dato invalido" ForeColor="Red"
            ValidationExpression="\d+\.?\d?\d?\d?\d?\d?\d?" 
            ValidationGroup="AgregarAduanaVU" />
             </div>
                       <div class = "col-lg-3">
                        <asp:Label ID="Label42" runat="server" Text="Aduana"></asp:Label>
            ...
            <div class = "row form-group " > 
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label40" runat="server" Text="Numero"></asp:Label>
                      <asp:TextBox runat="server" ID="txtNumero"  CssClass="form-control" />
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                  ControlToValidate="txtNumero" Display="Dynamic" ErrorMessage="Requerido" ForeColor="Red" 
                  ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
     
             </div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label41" runat="server" Text="Fecha"></asp:Label>
                       <asp:TextBox runat="server" ID="txtFechaVU" CssClass="form-control"   />
                        <asp:CompareValidator runat="server" ID="CompareValidator4" ControlToValidate="txtFechaPago" ForeColor="Red"
            ...
            ControlToValidate="txtFechaVU" Display="Dynamic" ErrorMessage="Requerido"  ForeColor="Red"
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
                </div>
                 <div class = "col-lg-3">
                      <asp:Button 
                     ID="btnAgregarPilgrims" runat="server" Cssclass="btn btn-outline-success" 
        ...
        <ContentTemplate>
            ...
            DataPlaceHolder="Escriba aquí..." AllowSingleDeselect="True"  CssClass="form-control"
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtUnidad" Display="Dynamic" 
              ...
              <div class = "row"> 
                ...
                <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label50" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
