...
{
    public partial class wfrFacturaIEDU : Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            edicion.autrvoe = this.txtr.Text;
            edicion.nombre = this.txtnombreE.Text;
            edicion.NivelEducativo = this.ddlniveleducativoE.SelectedValue;
            edicion.CURP = this.txtcurpe.Text;
            edicion.rfcpago = this.txtrfce.Text;
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            detalle.nombre = this.txtNombreAlumno.Text;
            detalle.rfcpago = this.txtrfcpago.Text;
            detalle.CURP = this.txtcurp.Text;
            detalle.NivelEducativo = this.ddlniveleducativo.SelectedItem.Value;
            detalle.autrvoe = this.txtautRVOE.Text;
        ...
        protected void gvDetalles_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Editar"))
            {
                ...
                this.txtnombreE.Text = edicion.nombre;
                this.txtcurpe.Text = edicion.CURP;
                this.txtrfce.Text = edicion.rfcpago;
                this.ddlniveleducativoE.SelectedValue = edicion.NivelEducativo.ToString();
                this.txtr.Text = edicion.autrvoe;
                // UpdatePanel7.Update();
                mpeEdita.Show();
             //   mpeEdita.Hide();
             //   mpeEdita.Show();
