<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFactura1888.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFactura1888"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label32" class="control-label" runat="server" Text="RFC"></asp:Label>
	    ...
	    <asp:TabPanel  runat="server"  ID="datosAddenda" HeaderText="Addenda">
         ...
         <ContentTemplate>
                ...
                <div class = "row form-group " > 
                   ...
                   <div class = "col-lg-12">
                      <h4> <asp:Label ID="Label31" runat="server" Text="Datos 1888"></asp:Label> </h4>
                   </div>
                ...
                <div class = "row form-group " > 
                 <div class = "col-lg-3"></div>
                   ...
                   <div class = "col-lg-3">
                   <asp:Label ID="Label30" runat="server" Text="GENERAL NUMPED"></asp:Label> 
                <asp:TextBox ID="txtNUMPED" runat="server" CssClass="form-contro"></asp:TextBox>
                                             </div>
              ...
              <div class = "row"> 
                ...
                <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label39" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
