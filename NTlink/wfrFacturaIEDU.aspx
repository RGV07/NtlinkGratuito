<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaIEDU.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFacturaIEDU"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label41" class="control-label" runat="server" Text="RFC"></asp:Label>
    ...
    <div class="body">
        ...
        <div class = "row form-inline"> 
         ...
         <div class = "row form-inline"> 
             ...
             <div class="col-lg-1" ></div>  
                    <div class="col-lg-5" >
                        <asp:Label  class="control-label" ID="Label36" runat="server" Text="nombreEstudiante"></asp:Label>
                   </div>
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtnombreE" runat="server" CssClass="form-control"/>
                    </div>
             </div>
              <div class = "row form-inline"> 
             <div class="col-lg-1" ></div>  
                    <div class="col-lg-5" >
                        <asp:Label  class="control-label" ID="Label37" runat="server" Text="CURP"></asp:Label>
                   </div>
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtcurpe" runat="server" CssClass="form-control"/>
                    </div>
             </div>
               <div class = "row form-inline"> 
             <div class="col-lg-1" ></div>  
                    <div class="col-lg-5" >
                        <asp:Label  class="control-label" ID="Label38" runat="server" Text="RFC Estudiante"></asp:Label>
                   </div>
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtrfce" runat="server" CssClass="form-control"/>
                    </div>
             </div>
            <div class = "row form-inline"> 
             <div class="col-lg-1" ></div>  
                    <div class="col-lg-5" >
                        <asp:Label  class="control-label" ID="Label39" runat="server" Text="Nivel Educativo"></asp:Label>
                   </div>
                    <div class="col-lg-6">
                        <asp:DropDownList ID="ddlniveleducativoE" runat="server" AutoPostBack="True" CssClass="form-control">
             ...
             </div><div class = "row form-inline"> 
             <div class="col-lg-1" ></div>  
                    <div class="col-lg-5" >
                        <asp:Label  class="control-label" ID="Label40" runat="server" Text="autRVOE"></asp:Label>
                   </div>
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtr" runat="server" CssClass="form-control"/>
                    </div>
             </div>
            </div>
  </div>
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
      ...
      <asp:Panel runat="server" CssClass="table-responsive">
       ...
       <div class = "row"> <%--Clave Unidad/No. Identificación--%>
            ...
            NoResultsText="No hay resultados coincidentes."  Height="16px"  SelectMethod=""          
        ...
        -                     <asp:CheckBox ID="descuento" runat="server" AutoPostBack="True" Checked="false" OnCheckedChanged="descuento_CheckedChanged"  Text=" % Desc" />
               <%--    <asp:Label ID="Label2" class="control-label" runat="server" Text=" % Desc"></asp:Label>
              ...
              <div class = "row"> 
                  ...
                  <div class = "row"> 
                      <div class = "form-group col-lg-12">
                        <h4>  <asp:Label ID="Label30" class="control-label" runat="server" Text="Datos del estudiante"></asp:Label></h4>
                    </div>
                    </div>
                  <div class="row">
                     <div class = "form-group col-lg-3">
                        <asp:Label ID="Label31" class="control-label" runat="server" Text="NombreAlumno"></asp:Label>
                        <asp:TextBox ID="txtNombreAlumno" runat="server" CssClass="form-control" Width="241px"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="rfvNombreAlumno" runat="server" 
                               ControlToValidate="txtNombreAlumno" CssClass="alert-error" ForeColor="Red"
                               Display="Dynamic" ErrorMessage="* Requerido" style="font-size: medium"
                                ValidationGroup="AgregarConcepto" />
                         </div>
                       <div class = "form-group col-lg-3">
                        <asp:Label ID="Label32" class="control-label" runat="server" Text="CURP"></asp:Label>
                              <asp:TextBox ID="txtcurp" runat="server" CssClass="form-control" Width="181px" MaxLength="18"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="rfvNombreAlumno0" runat="server"
                                       ...
                                       ErrorMessage="* Requerido" style="font-size: medium" ForeColor="Red"
                                       ValidationGroup="AgregarConcepto" />
                                
                           </div>
                        <div class = "form-group col-lg-3">
                        <asp:Label ID="Label33" class="control-label" runat="server" Text="RFCPago"></asp:Label>
                         <asp:TextBox ID="txtrfcpago" runat="server" CssClass="form-control" MaxLength="13" ></asp:TextBox>
                                  
                          </div>
                  </div>
                    <div class="row">
                     <div class = "form-group col-lg-3">
                        <asp:Label ID="Label34" class="control-label" runat="server" Text="Nivel Educativo"></asp:Label>
                          <asp:DropDownList ID="ddlniveleducativo" runat="server" AutoPostBack="True" CssClass="form-control">
                                         <asp:ListItem Value="Preescolar">Preescolar</asp:ListItem>
                                       <asp:ListItem Value="Primaria">Primaria</asp:ListItem>
                                       <asp:ListItem Value="Secundaria">Secundaria</asp:ListItem>
                                       <asp:ListItem Value="Profesional Tecnico">Profesional Tecnico</asp:ListItem>
                       ...
                       <div class = "form-group col-lg-3">
                        <asp:Label ID="Label35" class="control-label" runat="server" Text="autRVOE"></asp:Label>
                                  <asp:TextBox ID="txtautRVOE" runat="server" CssClass="form-control" Width="181px"></asp:TextBox>
                  ...
                  <div class = "row"> 
                   <div class="col-md-6 col-lg6" ></div>
                 ...
                 <div class = "row"> 
                   <asp:Panel runat="server" CssClass="table-responsive border border-success" style=" background-color: #2d282808;margin:0px auto ">
                         <asp:GridView ID="gvDetalles" runat="server" AutoGenerateColumns="False" GridLines="None" 
                          ShowHeaderWhenEmpty="True" DataKeyNames="Partida" Width="100%"  AlternatingRowStyle-HorizontalAlign="Center"
                      ...
                      <asp:BoundField HeaderText="Partida" DataField="Partida" ItemStyle-HorizontalAlign="Center" />
                       ...
                       <asp:BoundField HeaderText="Descuento" DataField="ConceptoDescuento" DataFormatString="${0:#,#.######}"
                        ...
                        <asp:BoundField HeaderText="Observaciones" DataField="Observaciones" />
                         <asp:BoundField HeaderText="NombreAlumno" DataField="Nombre" />
                         <asp:BoundField HeaderText="CURPAlumno" DataField="CURP" />
                         <asp:BoundField HeaderText="RFCPago" DataField="rfcpago" />
                         <asp:BoundField HeaderText="NivelEducativo" DataField="Niveleducativo" />
                   ...
                   --%>     <asp:TemplateField HeaderStyle-CssClass="sorting_disabled"  HeaderText= "Opciones"   ItemStyle-HorizontalAlign="Right" >
                             <ItemTemplate  >
                                <div class="row-fluid">
                                 <div class="form-inline">
