<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFactura.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFactura"  EnableEventValidation="false" %>
...
<script type="text/javascript">
    ...
    function HideImage()
    {
        var updproc = document.getElementById("<%= UpdateProgress2.ClientID %>");
    updproc.style.display = "none";
      //  $find('<%= UpdateProgress2.ClientID %>').get_element().style.display = 'none';
    }
       </script>
