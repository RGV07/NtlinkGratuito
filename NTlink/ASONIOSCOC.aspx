<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ASONIOSCOC.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.ASONIOSCOC"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label37" class="control-label" runat="server" Text="RFC"></asp:Label>
                ...
                <div class = "row form-group " > 
                    ...
                    <asp:TextBox runat="server" ID="txtFechaPago" CssClass="form-control"  Visible="False" />
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="alert-error"
                         ID="RequiredFieldValidator16" ControlToValidate="txtFechaPago"
         ...
         <ContentTemplate>
               ...
               <ContentTemplate>
                ...
                <div class = "row form-group " > 
                    <div class = "col-lg-1"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label31" runat="server" Text="TipoProveedor"></asp:Label>
                             <asp:TextBox ID="txtTipoProveedor" runat="server" MaxLength="2" ToolTip="Indica el tipo de proveedor, proporcionad por Asofarma" Width="50px" CssClass="form-control" />
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red"
                                ControlToValidate="txtTipoProveedor" Display="Dynamic" 
                                   ErrorMessage="Requerido" ValidationGroup="CrearFactura">
                               </asp:RequiredFieldValidator>
                                  <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" 
                                      runat="server" Enabled="True" FilterType="Custom, Numbers"
                                      TargetControlID="txtTipoProveedor" />
                                        
                    </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label30" runat="server" Text="NoProveedor"></asp:Label>
                     <asp:TextBox ID="txtNoProveedor" runat="server" MaxLength="10" 
                         ToolTip="Numero de Proveedor Asofarma" Width="100px" CssClass="form-control" />
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ForeColor="Red"
                              ControlToValidate="txtNoProveedor" Display="Dynamic" 
                              ErrorMessage="Requerido" ValidationGroup="CrearFactura">
                                          </asp:RequiredFieldValidator>
                         
                    </div>             
             <div class = "col-lg-3">
                        <asp:Label ID="Label32" runat="server" Text="OrdenCompra"></asp:Label>
                      <asp:TextBox ID="txtOrdenCompra" runat="server" MaxLength="12"
                          ToolTip="NC:mero de Orden de compra Asofarma" Width="100px" 
                          CssClass="form-control"/>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ForeColor="Red"
                         ControlToValidate="txtOrdenCompra" Display="Dynamic" ErrorMessage="Requerido"
                 ...
                 <div class = "row form-group " > 
                      <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label33" runat="server" Text="NoPartida"></asp:Label>
                    <asp:TextBox ID="txtNoPartida" runat="server" ToolTip="NC:mero de Partida"
                        Width="50px" CssClass="form-control" />
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ForeColor="Red"
                           ControlToValidate="txtNoPartida" Display="Dynamic" ErrorMessage="Requerido" 
                           ValidationGroup="AgregarAtributos"></asp:RequiredFieldValidator>
                      <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                          Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtNoPartida" />
                   </div>
              <div class = "col-lg-3">
                        <asp:Label ID="Label34" runat="server" Text="IvaAcreditable"></asp:Label>
                       <asp:TextBox ID="txtIvaAcreditable" runat="server" CssClass="form-control" ToolTip="Importe del IVA acreditable">
                </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ForeColor="Red"
                                                ControlToValidate="txtIvaAcreditable" Display="Dynamic" ErrorMessage="Requerido" 
                                                ValidationGroup="AgregarAtributos"></asp:RequiredFieldValidator>
                                             <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                                 FilterType="Numbers, Custom" TargetControlID="txtIvaAcreditable" ValidChars="." />
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator33" runat="server" ForeColor="Red"
                                                ControlToValidate="txtIvaAcreditable" Display="Dynamic" ErrorMessage="Dato invalido" 
                                                ValidationExpression="\d+\.?\d?\d?\d?\d?\d?\d?" ValidationGroup="AgregarAtributos" />
                                       
           
             </div>
                        <div class = "col-lg-3">
                        <asp:Label ID="Label35" runat="server" Text="IvaDevengado"></asp:Label>
               <asp:TextBox ID="txtIvaDevengado" runat="server" ToolTip="Importe del IVA devengado"
                   CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ForeColor="Red"
                                                ControlToValidate="txtIvaDevengado" Display="Dynamic" ErrorMessage="Requerido"
                                                ValidationGroup="AgregarAtributos"></asp:RequiredFieldValidator>
                                            
                                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server"
                                                FilterType="Numbers, Custom" TargetControlID="txtIvaDevengado" ValidChars="." />
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red"
                                                ControlToValidate="txtIvaDevengado" Display="Dynamic" ErrorMessage="Dato invalido" 
                                                ValidationExpression="\d+\.?\d?\d?\d?\d?\d?\d?" ValidationGroup="AgregarAtributos" />
                  ...
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-6">
                        <asp:Label ID="Label36" runat="server" Text="Otros"></asp:Label>
             <asp:TextBox ID="txtOtros" runat="server" TextMode="MultiLine" 
                 CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ForeColor="Red"
                                                ControlToValidate="txtOtros" Display="Dynamic" ErrorMessage="Requerido" 
                                                ValidationGroup="AgregarAtributos"></asp:RequiredFieldValidator>
                  ...
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                             <asp:Button ID="btnAtributos" runat="server"  Cssclass="btn btn-outline-success"
                                 onclick="btnAtributos_Click" Text="Agregar Atributo" 
                                 ValidationGroup="AgregarAtributos" Width="114px" />
             ...
             <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                        <asp:GridView ID="gvAmazon" runat="server" AutoGenerateColumns="False" GridLines="None" 
                          ShowHeaderWhenEmpty="True" Width="100%" 
                            AlternatingRowStyle-HorizontalAlign="Center"
                             onrowcommand="gvAmazon_RowCommand"
              ...
              <div class = "row"> 
                 ...
                 <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label44" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
