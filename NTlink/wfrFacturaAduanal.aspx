<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaAduanal.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFacturaAduanal"  EnableEventValidation="false" %>
        ...
        <div class="body">
            <br />
                <div class = "row">
                  ...
                  <asp:Label ID="Label54" class="control-label" runat="server" Text="RFC"></asp:Label>
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
      ...
      <asp:Panel runat="server" CssClass="table-responsive">
        ...
        <div class = "card mt-2"> 
            ...
            <div class = "card-body">
                <div class="row"></div>
                <br />
                 <asp:TabContainer ID="tabContainerPilgrims" runat="server"  Width="100%" Height="100%" ActiveTabIndex="1" CssClass="MyTabStyle">
	    <asp:TabPanel  runat="server"  ID="datosAddenda" HeaderText="Addenda" Height="100%">
    ...
    <ContentTemplate>
                ...
                <div class = "row form-group " > 
                    ...
                    <div class = "col-lg-3">
                            <h4>   <asp:Label ID="Label30" runat="server" Text="Datos del Embarque"></asp:Label></h4>
                 </div>
                    <div class = "col-lg-3">
                           <h4>    <asp:Label ID="Label32" runat="server" Text="Datos del Despacho"></asp:Label></h4>
                 </div>
                    <div class = "col-lg-3"></div>
                ...
                <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label31" runat="server" Text="Guia master / B.L."></asp:Label>
                          <asp:TextBox runat="server" ID="txtGuiaMaster" CssClass="form-control" />
                  </div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label33" runat="server" Text="Referencia Interna"></asp:Label>
             ...
             <div class="row form-group ">
                 <div class="col-lg-3"></div>
                 <div class="col-lg-3">
                     <asp:Label ID="Label34" runat="server" Text="Guia house / Talón"></asp:Label>
              ...
              <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label36" runat="server" Text="Tipo cambio Fletes"></asp:Label>
                        <asp:TextBox runat="server" ID="txtTipoCambioFletes" CssClass="form-control" />
                       </div>
                        <div class = "col-lg-3">
                        <asp:Label ID="Label37" runat="server" Text="Aduana"></asp:Label>
                   ...
                   <div class = "row form-group "> 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label38" runat="server" Text="Tipo Operación"></asp:Label>
                        <asp:TextBox runat="server" ID="txtTipoOperacion" CssClass="form-control" />
            
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label39" runat="server" Text="Pedimento"></asp:Label>
 ...
 <div class = "row form-group" > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label40" runat="server" Text="Valor aduana"></asp:Label>
                 <asp:TextBox runat="server" ID="txtValorAduana" CssClass="form-control"/>
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label41" runat="server" Text="Tipo cambio Pedimento"></asp:Label>
 ...
 <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label42" runat="server" Text="Mercancía"></asp:Label>
                        <asp:TextBox runat="server" ID="txtMercancia" CssClass="form-control"/>
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label43" runat="server" Text="L. Aer. / Mrtma. / Terr."></asp:Label>
 ...
 <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label44" runat="server" Text="No. Bultos"></asp:Label>
               <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control" />
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label45" runat="server" Text="Días de Crédito"></asp:Label>
 ...
 <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label46" runat="server" Text="Peso Bruto"></asp:Label>
                <asp:TextBox runat="server" ID="txtPesoBruto" CssClass="form-control" />
                       </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label47" runat="server" Text="Fecha Vencimiento"></asp:Label>
 ...
 <div class = "row form-group " > 
                    <div class = "col-lg-3"></div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label48" runat="server" Text="Contenedor(es)"></asp:Label>
                        <asp:TextBox runat="server" ID="txtContenedores" TextMode="MultiLine" CssClass="form-control" />
                    </div>
                    <div class = "col-lg-3">
                        <asp:Label ID="Label49" runat="server" Text="Facturas"></asp:Label>
 ...
 <div class = "row form-group " > 
                    <div class = "col-lg-12">
                      ...
                      <h4>  <asp:Label ID="Label51" runat="server" Text="Conceptos Addenda"></asp:Label></h4>
     ...
     <div class = "row form-group " > 
             <div class = "col-lg-1"></div>
                    ...
                    <div class = "col-lg-10">
                       ...
                       <asp:Label ID="Label50" runat="server" Text="Descripción"></asp:Label>
 ...
 <div class = "row form-group"> 
                   ...
                   <div class = "col-lg-3">
                        <asp:Label ID="Label52" runat="server" Text="Factura / Referencia"></asp:Label>
                       <asp:TextBox runat="server" ID="txtNoFactura" CssClass="form-control" />
        
                       </div>
                   <div class = "col-lg-3">
                        <asp:Label ID="Label53" runat="server" Text="Importe"></asp:Label>
               ...
               <asp:RequiredFieldValidator runat="server" ID="rfvTotalFactura"
                 ...
                 ErrorMessage="* Importe Inválido" Display="Dynamic"  ForeColor="Red"
                   ...
                   <div class = "col-lg-3">
                                  <asp:Button runat="server" ID="btnAgregarConceptoAduana"
                                      ValidationGroup="AgregarConceptoAduana" class="btn btn-outline-success"
        ...
        <div style="text-align:center; width:100%">
                    <div class="border border-success" style=" width:80%;   background-color: #2d282808;margin:0px auto  " >
                               <asp:GridView ID="gvConceptosAduana" runat="server" AutoGenerateColumns="False" GridLines="None" 
                          ShowHeaderWhenEmpty="True" DataKeyNames="Partida" Width="100%"
                            OnRowCommand="gvConceptosAduana_RowCommand"   CssClass="table table-hover table-striped grdViewTable"
                             >
            ...
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField><asp:ButtonField Text="Eliminar" CommandName="EliminarConcepto" /></Columns>
                     ...
                     <Triggers>
                          <asp:AsyncPostBackTrigger ControlID="gvConceptosAduana"/>
                     </Triggers>
             </asp:UpdatePanel>
                   ...
                   <div class = "row"> 
                    <div class = "form-group col-lg-3">
                      <asp:Label ID="Label55" runat="server" ForeColor="Red" Text="* "></asp:Label>
                         ...
                         <cc1:DropDownListChosen ID="ddlClaveUnidad" runat="server" Width="100%" 
            NoResultsText="No hay resultados coincidentes."          
            DataPlaceHolder="Escriba aquí..." AllowSingleDeselect="True"  CssClass="form-control"
                            AutoPostBack="True"   onselectedindexchanged="ddlClaveUnidad_SelectedIndexChanged" 
        ...
        -                  <asp:CheckBox ID="descuento" runat="server" AutoPostBack="True" OnCheckedChanged="descuento_CheckedChanged"  Text=" % Desc" />
              ...
              <div class = "row"> 
                       <div class = "form-group col-lg-4">
                          <asp:Label ID="Label60" runat="server" ForeColor="Red" Text="* "></asp:Label>
                ...
                <div class="row">
                     <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <asp:Label ID="Label61" runat="server" ForeColor="Red" Text="Obligatorios (*)"></asp:Label> 
    ...
    <asp:Button runat="server" ID="btnSelloDummy" Style="display: none;" />
        ...
        <div class = "card mt-2">
            ...
            <div class = "card-body">
             ...
             <div class = "row">
                           <div  class="col-md-7 col-sm-0"></div>
                           <div class = "col-md-2 col-sm-6  text-right" style="padding:0"><b>Total Gastos Addenda</b>:</div>
                           <div class = "d-inline-flex-reverse col-md-2 col-sm-6 text-right" style="padding:0">
                           <asp:Label runat="server" ID="lblTotalAddenda" /></div>
                           <div  class="col-md-1 col-sm-0"></div>
                           </div>
             <div class = "row">
                           <div  class="col-md-7 col-sm-0"></div>
                           <div class = "col-md-2 col-sm-6  text-right" style="padding:0"><b>Anticipo</b>:</div>
                           <div class = "d-inline-flex-reverse col-md-2 col-sm-6 text-right" style="padding:0">
                           <asp:Label runat="server" ID="lblAnticipo" /></div>
                           <div  class="col-md-1 col-sm-0"></div>
                           </div>
             <div class = "row">
                           <div  class="col-md-7 col-sm-0"></div>
                           <div class = "col-md-2 col-sm-6  text-right" style="padding:0"><b>Saldo</b>:</div>
                           <div class = "d-inline-flex-reverse col-md-2 col-sm-6 text-right" style="padding:0">
                           <asp:Label runat="server" ID="lblGranTotal" /></div>
                           <div  class="col-md-1 col-sm-0"></div>
                           </div>
