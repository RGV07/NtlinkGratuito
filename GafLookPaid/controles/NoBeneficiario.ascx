...
<asp:Label ID="Label2" runat="server" Text="No Beneficiarios" Font-Bold="True" 
...
<div class = "row">
   ...
   <asp:Label ID="Label3" runat="server" ForeColor="Red" Text="*"></asp:Label>
                          <asp:Label ID="Label1" runat="server" Text="PaisDeResidParaEfecFisc"></asp:Label>

        <asp:DropDownList ID="ddlPaisDeResidParaEfecFisc" runat="server" CssClass="form-control"
...
<div class = "row">
    ...
    <asp:Label ID="Label9" runat="server" ForeColor="Red" Text="*"></asp:Label>
                      <asp:Label ID="Label4" runat="server" Text="ConceptoPago"></asp:Label>
    ...
    <asp:Label ID="Label10" runat="server" ForeColor="Red" Text="*"></asp:Label>
                      <asp:Label ID="Label5" runat="server" Text="DescripcionConcepto"></asp:Label>
    <asp:TextBox ID="txtDescripcionConcepto" runat="server" Width="442px" CssClass="form-control"
