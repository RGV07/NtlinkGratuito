...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
                ...
                xmlns:arrendamientoenfideicomiso="arrendamientoenfideicomiso"
                xmlns:dividendos="dividendos" xmlns:enajenaciondeacciones="enajenaciondeacciones" 
                xmlns:fideicomisonoempresarial="fideicomisonoempresarial" xmlns:intereses="intereses"
                xmlns:intereseshipotecarios="intereseshipotecarios" xmlns:operacionesderivados="operacionesderivados" 
                xmlns:pagosaextranjeros="pagosaextranjeros" xmlns:planesderetiro11="planesderetiro11"
                xmlns:premios="premios" xmlns:sectorfinanciero="sectorfinanciero">
